...
class CSPNet(nn.Module):
    ...
    def gen_edges(
        ...
        # if edge_index is not None and to_jimages is not None:
        #     # user‐provided connectivity → just recompute frac_diff
        #     frac_diff = (frac_coords[edge_index[1]] - frac_coords[edge_index[0]])
        #     frac_diff = frac_diff % 1.0 + to_jimages.float()
